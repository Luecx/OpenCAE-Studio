...
def test_leading_ribbon_selector_has_explicit_vertical_separator():
    page = (ROOT / "opencae/ui/other/ribbon/ribbon_page.py").read_text(encoding="utf-8")
    part = (ROOT / "opencae/ui/other/ribbon/part_page.py").read_text(encoding="utf-8")
    analysis = (ROOT / "opencae/ui/other/ribbon/analysis_page.py").read_text(encoding="utf-8")
    studies = (ROOT / "opencae/ui/other/ribbon/studies_page.py").read_text(encoding="utf-8")
