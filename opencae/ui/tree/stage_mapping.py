...
PART_KINDS = {"parts", "part", "geometry", "geometry_feature", "mesh", "seed", "mesh_control", "element_control", "nodes", "elements", "element_category", "element_definition", "node_sets", "node_set", "element_sets", "element_set", "surfaces", "surface", "coordinate_systems", "coordinate_system", "reference_points", "reference_point", "datums", "datum_point", "datum_vector", "datum_plane", "orientations", "orientation", "section_assignments", "section_assignment"}
ASSEMBLY_KINDS = {"assembly", "instances", "instance", "asm_node_sets", "asm_node_set", "asm_element_sets", "asm_element_set", "asm_surfaces", "asm_surface", "asm_coordinate_systems", "asm_coordinate_system", "asm_reference_points", "asm_reference_point"}
