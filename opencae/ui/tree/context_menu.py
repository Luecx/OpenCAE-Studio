...
MAP = {
    ...
    "amplitude": (A.EDIT_SELECTED, A.DELETE_SELECTED),
    ...
    "parts": (A.NEW_PART,),
    "part": (A.SKETCH_FEATURE, A.DUPLICATE_PART, A.IMPORT_GEOMETRY, A.PARTITION, A.REBUILD_GEOMETRY, A.DEFAULT_SEED, A.GENERATE_MESH, A.CREATE_NODE, A.CREATE_ELEMENT, A.DELETE_SELECTED),
    "geometry": (A.SKETCH_FEATURE, A.IMPORT_GEOMETRY, A.PARTITION, A.REBUILD_GEOMETRY),
    "mesh": (A.DEFAULT_SEED, A.EDGE_SEED, A.ELEMENT_CONTROLS, A.MESH_SETTINGS, A.GENERATE_MESH, A.CLEAR_MESH, A.CREATE_NODE, A.EDIT_NODE, A.DELETE_NODE, A.CREATE_ELEMENT, A.EDIT_ELEMENT, A.DELETE_ELEMENT),
