...
MAP={
 ...
 "mesh":(A.DEFAULT_SEED,A.EDGE_SEED,A.MESH_CONTROL,A.ELEMENT_CONTROLS,A.MESH_SETTINGS,A.GENERATE_MESH,A.CLEAR_MESH),"elements":(A.ELEMENT_CONTROLS,),
 "regions":(A.NODE_SET,A.ELEMENT_SET,A.SURFACE),"regions_mixed":(),"region":(A.EDIT_SELECTED,A.DELETE_SELECTED),"node_sets":(A.NODE_SET,),"element_sets":(A.ELEMENT_SET,),"surfaces":(A.SURFACE,),"coordinate_systems":(A.PART_CSYS,),"reference_points":(A.PART_RP,),"section_assignments":(A.SECTION_ASSIGNMENT,),
 "instances":(A.ADD_INSTANCE,A.DUPLICATE_INSTANCE),"asm_regions":(A.ASM_NODE_SET,A.ASM_ELEMENT_SET,A.ASM_SURFACE),"asm_regions_mixed":(),"asm_region":(A.EDIT_SELECTED,A.DELETE_SELECTED),"asm_node_sets":(A.ASM_NODE_SET,),"asm_element_sets":(A.ASM_ELEMENT_SET,),"asm_surfaces":(A.ASM_SURFACE,),"asm_coordinate_systems":(A.ASM_CSYS,),"asm_reference_points":(A.ASM_RP,),"constraints":(A.CONSTRAINT_KINEMATIC,A.CONSTRAINT_DISTRIBUTING,A.CONSTRAINT_TIE,A.CONSTRAINT_RIGID,A.CONSTRAINT_EQUATION,A.CONSTRAINT_MPC),
