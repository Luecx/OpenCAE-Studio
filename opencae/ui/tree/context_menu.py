...
MAP = {
    ...
    "parts": (A.NEW_PART,),
    "part": (A.DUPLICATE_PART, A.IMPORT_GEOMETRY, A.PARTITION, A.REBUILD_GEOMETRY, A.DEFAULT_SEED, A.GENERATE_MESH, A.CREATE_NODE, A.CREATE_ELEMENT, A.DELETE_SELECTED),
