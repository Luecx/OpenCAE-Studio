"""Displays live FEMaster output and cancellation controls for a topology run."""
...
class TopologyRunDialog(QDialog):
    """Persistent modeless console that can be hidden and reopened during a run."""
    ...
    def append(self, text):
        ...
        self.output.insertPlainText(str(text).rstrip() + "\n")
