...
class PyVistaViewport(QWidget):
    ...
    def __init__(self, store=None, parent=None):
        ...
        self.plotter = QtInteractor(self.canvas); self.canvas.set_render_widget(self.plotter); self.plotter.set_background(PALETTE["viewport"])
        ...
        self.context_pick = ContextPickManager(self); self.datum_preview = DatumPreview(); self.result_query = ResultQueryState(self)
