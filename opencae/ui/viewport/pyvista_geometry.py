...
def add_geometry(plotter, snapshot, instance=None):
    ...
    for patch in snapshot.surfaces:
        ...
        faces[actor] = ActorReference(instance.name if instance else None, 2, patch.tag)
    for patch in snapshot.edges:
        ...
        edges[actor] = ActorReference(instance.name if instance else None, 1, patch.tag)
    for patch in snapshot.vertices:
        ...
        vertices[actor] = ActorReference(instance.name if instance else None, 0, patch.tag)
