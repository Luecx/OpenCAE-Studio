...
def create(actions, store):
    ...
    specs = (
        RibbonGroupSpec("GEOMETRY", (A.NEW_PART, A.IMPORT_GEOMETRY, A.IMPORT_MESH, A.PARTITION, A.REBUILD_GEOMETRY, A.SUPPRESS_FEATURE)),
        RibbonGroupSpec("DATUM", (A.DATUM_POINT, A.DATUM_VECTOR, A.DATUM_PLANE)),
        RibbonGroupSpec("MESH", (A.DEFAULT_SEED, A.EDGE_SEED, A.MESH_CONTROL, A.MESH_SETTINGS, A.GENERATE_MESH, A.CLEAR_MESH)),
