...
def specs(c):
    return (
        ...
        ActionSpec(A.CREATE_NODE, "Create Node", I.NODE_SET, c.part.create_node),
        ActionSpec(A.EDIT_NODE, "Edit Node", I.EDIT, c.part.edit_node),
        ActionSpec(A.DELETE_NODE, "Delete Node", I.DELETE, c.part.delete_node),
        ActionSpec(A.CREATE_ELEMENT, "Create Element", I.ELEMENT, c.part.create_element),
        ActionSpec(A.EDIT_ELEMENT, "Edit Element", I.EDIT, c.part.edit_element),
        ActionSpec(A.DELETE_ELEMENT, "Delete Element", I.DELETE, c.part.delete_element),
