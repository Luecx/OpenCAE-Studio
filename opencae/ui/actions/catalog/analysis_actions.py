...
def specs(c):
    return (
        ActionSpec(A.STEP_LINEAR, "Linear Static", I.STEP_LINEAR, lambda: c.analysis.create_step(StepType.LINEAR_STATIC)),
        ActionSpec(A.STEP_NONLINEAR, "Nonlinear", I.STEP_NONLINEAR, lambda: c.analysis.create_step(StepType.NONLINEAR_STATIC)),
        ActionSpec(A.STEP_MODAL, "Modal", I.STEP_MODAL, lambda: c.analysis.create_step(StepType.EIGENFREQUENCY)),
        ActionSpec(A.STEP_BUCKLING, "Buckling", I.STEP_BUCKLING, lambda: c.analysis.create_step(StepType.LINEAR_BUCKLING)),
        ActionSpec(A.STEP_TRANSIENT, "Transient", I.STEP_TRANSIENT, lambda: c.analysis.create_step(StepType.TRANSIENT)),
        ...
        ActionSpec(A.DECK_FORMAT_MANAGER, "Input Deck Formats…", I.DECK, c.solver.format_manager),
