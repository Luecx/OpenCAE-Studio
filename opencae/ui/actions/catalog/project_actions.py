...
def specs(c, window, store):
    return (
        ActionSpec(A.NEW_PROJECT, "New Project", I.FILE, c.project.new, "Ctrl+N"),
        ActionSpec(A.OPEN_PROJECT, "Open Project…", I.FILE, c.project.open, "Ctrl+O"),
        ...
        ActionSpec(A.UNDO, "Undo", I.EDIT, store.undo, "Ctrl+Z"),
        ActionSpec(A.REDO, "Redo", I.EDIT, store.redo, "Ctrl+Y"),
