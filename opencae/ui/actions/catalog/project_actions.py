"""Declare project/document and application-level actions."""
...
def specs(c, window, store):
    return (
        ...
        ActionSpec(A.PROJECT_SETTINGS, "Project Properties…", I.SETTINGS, c.project.settings_dialog),
        ActionSpec(A.PREFERENCES, "Settings…", I.SETTINGS, c.project.preferences),
