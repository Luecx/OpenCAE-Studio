...
def specs(controllers):
    ...
    return (
        ...
        ActionSpec(A.OPT_FILTER, "Filters", I.RANGE, studies.filter_settings),
        ActionSpec(A.OPT_SYMMETRY, "Symmetry", I.CSYS, studies.symmetry),
        ...
        ActionSpec(A.OPT_THRESHOLD, "Threshold", I.RANGE, studies.threshold),
    )
