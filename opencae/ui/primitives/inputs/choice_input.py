"""Canonical choice editor with the OpenCAE painted chevron and popup sizing."""
...
class ChoiceInput(QComboBox):
    """Primary combo whose popup shows every entry when screen space permits."""
