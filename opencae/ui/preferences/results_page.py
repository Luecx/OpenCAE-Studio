...
class ResultsPage(PreferencePage):
    """Edit visual defaults applied to the Results ribbon controls."""
    ...
    def __init__(self, settings, parent=None):
        ...
        self.add_toggle(settings, "results/show_mesh_lines", "Show mesh lines", default=True)
        self.add_toggle(settings, "results/show_boundary_lines", "Show model boundaries", default=True)
        self.add_toggle(
            settings,
