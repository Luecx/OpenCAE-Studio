...
from opencae.ui.foundation.metrics import RIBBON_PAGE_HEIGHT, VIEWPORT_TOOL_HEIGHT
from opencae.ui.foundation.theme import PALETTE
from opencae.ui.other.ribbon.ribbon_page import ResponsiveRibbonPage
from opencae.ui.other.ribbon.specs import RibbonGroupSpec
from opencae.ui.primitives.buttons import ButtonViewportAction, ButtonViewportToggle
from opencae.ui.other.viewport.selection_toolbar import SelectionToolbar
...
class SketchFeatureDialog(_BaseSketchFeatureDialog):
    ...
    def _build_workspace(self, parent):
        ...
        self.view_sketch = ButtonViewportToggle("Sketch", parent=self.viewport_toolbar)
        ...
        self.fit_button = ButtonViewportAction("Fit", parent=self.viewport_toolbar)
