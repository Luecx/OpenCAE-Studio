...
from opencae.ui.primitives.semantic_controls import label
...
class RunAnalysisDialog(QDialog):
    ...
    def __init__(self, analysis, solver_adapters, settings, parent=None):
        ...
        root.setSpacing(14)
        root.addWidget(LabelSection("Run Analysis"))
        subtitle = label(
        ...
        apply_primary_input_geometry(self.solver)
        form.addRow("Solver", self.solver)

        self.deck_profile = SelectForm()
        apply_primary_input_geometry(self.deck_profile)
