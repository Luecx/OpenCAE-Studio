"""Provides the Part section-assignment editor using canonical field components."""
    ...
    def __init__(
        ...
        root.addWidget(
            FieldRow(
                ...
                FormField("Orientation", self.orientation),
            )
        )
