...
from .material_disclosure_button import MaterialDisclosureButton
...
class MaterialBehaviorCard(QFrame):
    ...
    A card is visually active only while its editor body is expanded. Merely
    defining a behavior does not give the card the blue focus border.
    """
    ...
    def __init__(self, category: str, behavior=None, units=None, parent=None):
        ...
        self._editors: dict[str, ControlNumericUnit] = {}
        ...
        self.body_layout.setContentsMargins(18, 12, 18, 18)
    ...
    def _build_header(self) -> QWidget:
        ...
        self.chevron = MaterialDisclosureButton()
    ...
    def _rebuild_body(self) -> None:
        ...
        self.body_layout.addWidget(FormField("Model", self.kind))
        ...
        for position, (key, label_text, default, quantity) in enumerate(specs):
            ...
            editor = ControlNumericUnit(values.get(key, default), unit)
            self._editors[key] = editor
            field = FormField(label_text, editor)
    ...
    def _sync_state(self) -> None:
        ...
        # Dynamic properties only affect QSS after Qt repolishes the widgets.
