...
from opencae.ui.components import RegionSelectionWidget
...
class RegionDialog(QDialog):
    ...
    def __init__(
        ...
        *,
        ...
        self.name = InputFormText(getattr(region, "name", default_name))
        root.addWidget(FormField("Name", self.name))
        root.addWidget(LabelSection("Region Definition"))
