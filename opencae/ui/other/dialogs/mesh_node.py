    ...
    def __init__(
        ...
        *,
        ...
        if self.editing:
            ...
            root.addWidget(FormField("Node to edit", target_row))
        ...
        root.addWidget(
            FieldRow(
                FormField("Node ID", self.node_id),
                FormField("Origin", self.origin),
            )
        )
        ...
        root.addWidget(FormField("Global coordinates", self.coordinates))
        ...
        if self.editing:
            ...
            for label, key in (
                ...
                root.addWidget(FormField(label, control))
