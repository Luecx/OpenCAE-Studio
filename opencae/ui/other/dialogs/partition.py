...
from opencae.ui.components import CompactRegionSelector, PointSelectionWidget, ControlReferenceSelector
...
class PartitionDialog(QDialog):
    ...
    def __init__(
        ...
        *,
        ...
        root.addWidget(
            FieldRow(
                FormField("History feature", self.name),
                FormField("Partition method", self.kind),
            )
        )

        root.addWidget(LabelSection("Partition Definition"))
    ...
    def _build_pages(self):
        ...
        self.datum_plane = ControlReferenceSelector(
        ...
        self.fraction = ControlNumericUnit(
            0.5,
            "",
            minimum=0.000001,
            maximum=0.999999,
