...
class VisibilityDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        apply_primary_input_geometry(self.mode)
        self.mode.currentIndexChanged.connect(self._mode_changed)
        root.addWidget(FormField("Entity type", self.mode))

        root.addWidget(LabelSection("Hidden Entities"))
        self.summary = LabelForm("0 hidden")
