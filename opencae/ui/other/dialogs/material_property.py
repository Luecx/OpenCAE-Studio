...
from opencae.ui.components.dialogs import dialog_buttons, scaffold_dialog
...
class MaterialPropertyDialog(QDialog):
    ...
    def __init__(self, behavior=None, parent=None, category=None, units=None):
        ...
        scaffold.root.addWidget(LabelSection("Property Values"))
    ...
    def _add_page(self, kind):
        ...
        for text, default, quantity in _PROPERTY_SPECS[kind]:
            ...
            blocks.append(FormField(text, editor))
        ...
        for index in range(0, len(blocks), 2):
            ...
            layout.addWidget(FieldRow(*pair) if len(pair) == 2 else pair[0])
        layout.addStretch(1)
