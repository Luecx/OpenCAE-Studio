from opencae.ui.components.apply_form_dialog import ApplyFormDialog
from opencae.ui.components.fields import FieldSpec


class DefaultSeedDialog(ApplyFormDialog):
    def __init__(self, seed=None, parent=None, units=None):
        ...
        super().__init__(
            ...
            (
                ...
                FieldSpec("size", "Approximate global size", "float", seed.size if seed else 5.0, minimum=1e-12, suffix=length_suffix),
