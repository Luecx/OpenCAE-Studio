...
from opencae.ui.components.controls import ControlPickReference
...
class TopologySymmetryDialog(NamedEntityDialog):
    ...
    def __init__(
        ...
        *,
        ...
        self.add_widget(LabelSection("Symmetry Definition"))
        self.add_widget(
            FieldRow(
                FormField("Type", self.kind),
                FormField("Occurrences", self.occurrences),
            )
        )
        self.add_widget(FormField("Reference", self.reference))
