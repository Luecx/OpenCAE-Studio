...
class TopologyOptimizationDialog(NamedEntityDialog):
    ...
    def __init__(
        ...
        *,
        ...
        self.analysis = ControlReferenceSelector(
            analyses,
        ...
        self.add_widget(LabelSection("Design Domains"))
        self.add_widget(FormField("Design domain", self.design))
        self.add_widget(FormField("Frozen solid", self.solid))
        self.add_widget(FormField("Frozen void", self.void))
        self.finish()
