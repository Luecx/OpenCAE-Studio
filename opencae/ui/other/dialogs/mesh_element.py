...
class MeshElementDialog(QDialog):
    ...
    def __init__(
        ...
        *,
        ...
        root.addWidget(
            FieldRow(
                FormField("Element ID", self.element_id),
                FormField("Element type", self.element_type),
            )
        )
        ...
        root.addWidget(FormField("Requirement", self.requirement))
        ...
        if self.details:
            ...
            for label, key in (
                ...
                root.addWidget(FormField(label, ControlReadOnlyValue(str(value or "—"))))
