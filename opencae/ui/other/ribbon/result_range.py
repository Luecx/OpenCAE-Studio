...
class ResultRangeButton(ButtonResultsRibbonOptions):
    ...
    def __init__(self, parent=None):
        ...
        layout.addWidget(FormField("Number of levels", levels_row))
        ...
        color_layout.addWidget(FormField("Below range", self.below_color), 1)
        color_layout.addWidget(FormField("Above range", self.above_color), 1)
