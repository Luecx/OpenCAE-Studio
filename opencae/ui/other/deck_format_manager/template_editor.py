...
from opencae.ui.components.fields import FieldSpec, create_editor
from opencae.ui.primitives.buttons import ButtonSpec
from opencae.ui.primitives import LabelRole
...
from opencae.ui.primitives.semantic_controls import button, label
...
class DeckTemplateEditor(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        preview_header.addWidget(LabelSection("Output Preview"))
    ...
    def _build_controls(self) -> QHBoxLayout:
        ...
        controls.addWidget(FormField("Float format", self.float_format))
        return controls
    ...
    def _build_template_panel(self) -> QWidget:
        ...
        layout.addWidget(LabelSection("Template Editor"))
        helper = label(
    ...
    def _build_fields_panel(self) -> QWidget:
        ...
        layout.addWidget(LabelSection("Available Fields"))
        helper = label(
        ...
        self.insert_button = apply_primary_input_geometry(
