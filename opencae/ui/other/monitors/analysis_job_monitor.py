...
from opencae.ui.components import MonospaceOutputView
...
class AnalysisJobMonitor(QDialog):
    ...
    def _build_output_panel(self) -> QWidget:
        ...
        layout.setSpacing(8)
        layout.addWidget(LabelSection("Solver Output"))
    ...
    def _build_runtime_panel(self, store, job) -> QWidget:
        ...
        layout.addWidget(LabelSection("Runtime Details"))
        ...
        layout.addWidget(LabelSection("Step / Post Checks"))
