...
class PreferencePage(QWidget):
    ...
    def __init__(self, title: str, description: str, parent=None):
        ...
        summary = LabelForm(str(description))
    ...
    def add_section(self, title: str, description: str = "") -> None:
        ...
        self.root.addWidget(LabelSection(str(title)))
        if description:
            label = LabelForm(str(description))
    ...
    def add_field(
        ...
        *,
        ...
        self.root.addWidget(FormField(label, editor))
    ...
    def add_custom_field(
        ...
        self.root.addWidget(FormField(label, widget))
