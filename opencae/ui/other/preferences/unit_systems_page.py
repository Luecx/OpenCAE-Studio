...
from opencae.ui.other.preferences.unit_system_editor import UnitSystemEditor
from opencae.ui.other.preferences.unit_system_table import UnitSystemTable
...
from opencae.ui.primitives.semantic_controls import button
...
class UnitSystemsPage(QWidget):
    ...
    def __init__(self, systems, selected, parent=None):
        ...
        left.setSpacing(10)
        left.addWidget(LabelSection("Unit Systems"))
        ...
        self.current = SelectForm()
        self.current.setMinimumWidth(0)
        apply_primary_input_geometry(self.current)
        right.addWidget(FormField("Current unit system", self.current))

        right.addWidget(LabelSection("Base Units"))
        self.editor = UnitSystemEditor(self._editor_changed)
        right.addWidget(self.editor)
        right.addWidget(LabelSection("Derived Units"))
