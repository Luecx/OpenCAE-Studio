...
from opencae.ui.other.panels.jobs_panel import JobsPanel
from opencae.ui.other.panels.log_panel import LogPanel
from opencae.ui.other.panels.time_manager_contours import ResultTimeManagerPanel
