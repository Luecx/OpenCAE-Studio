...
def legacy_part(data: dict[str, Any]) -> Part:
    ...
    part.orientations = [Orientation(**item) for item in collections["orientations"]]
    part.section_assignments = [SectionAssignment(**item) for item in collections["section_assignments"]]
    return part
