...
QUANTITIES = (
    ...
    Quantity("compliance", "Inverse Pressure / Compliance", (2, -1, 0, 0)),
    ...
    Quantity("frequency", "Frequency / Angular Velocity", (0, 0, -1, 0)),
    Quantity("angular_acceleration", "Angular Acceleration", (0, 0, -2, 0)),
